...
This adds a menu entry Tools → Classic Add-ons Archive, as well as a toolbar icon.  Clicking either of these opens a new window with an Add-ons search page (URL `caa:addon`), structured like AMO.  Old versions can be accessed from each add-on's page.
